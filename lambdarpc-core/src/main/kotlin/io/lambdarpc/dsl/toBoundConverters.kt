...
public suspend fun <R> RemoteFrontendFunction0<FreeInvoker, R>.toBound(): RemoteFrontendFunction0<BoundInvoker, R> =
    RemoteFrontendFunction0(bound(), rc)

public suspend fun <A, R> RemoteFrontendFunction1<FreeInvoker, A, R>.toBound(): RemoteFrontendFunction1<BoundInvoker, A, R> =
    RemoteFrontendFunction1(bound(), c1, rc)

public suspend fun <A, B, R> RemoteFrontendFunction2<FreeInvoker, A, B, R>.toBound(): RemoteFrontendFunction2<BoundInvoker, A, B, R> =
    RemoteFrontendFunction2(bound(), c1, c2, rc)

public suspend fun <A, B, C, R> RemoteFrontendFunction3<FreeInvoker, A, B, C, R>.toBound(): RemoteFrontendFunction3<BoundInvoker, A, B, C, R> =
